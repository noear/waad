package org.noear.waad.generator.service;

import org.noear.waad.generator.mapper.JavaCodeBlock;
import org.noear.waad.generator.mapper.TypeBlock;
import org.noear.waad.generator.mapper.XmlSqlBlock;
import org.noear.waad.generator.mapper.XmlSqlVar;
import org.noear.waad.generator.utils.IOUtils;
...
public class XmlSqlServiceGenerator {
    ...
    public static void generate(File baseDir, File sourceDir) {
        try {
            String path = (baseDir.getAbsolutePath() + "/src/main/resources/waad");
    ...
    public static JavaCodeBlock parse(File xmlFile) throws Exception{
        ...
        //String classname = xmlFile.getName().split("\\.")[0]; //namespace.replace(".","_"); //"waad_xml_sql";
