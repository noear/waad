...
##### 所有 waad 的操作，都是基于 DbContext 上的接口的操作。即，一切从构建 DbContext 实例开始：
...
//列表([]替代<>)
return="List[waaddemo.mapper.UserModel]" => List<UserModel>
...
### (八) 语法说明
* [《WOOD XML 语法》](https://gitee.com/noear/waad/blob/master/WOOD_XML_%E8%AF%AD%E6%B3%95.md)
* [《WOOD JAVA 接口字典》](https://gitee.com/noear/waad/blob/master/WOOD_JAVA_%E6%8E%A5%E5%8F%A3%E5%AD%97%E5%85%B8.md)
